...
export const ConfirmationPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- ticketIds derived from ticketIdsParam; using ticketIds would re-run every render (new array ref)
  }, [ticketIdsParam]);
        ...
        {tickets.map((ticket) => (
          <Card key={ticket.id} className={styles.ticketCard}>
            <div className={styles.ticketInfo}>
              ...
              <Text>
                Отправление: {formatDateTime(ticket.trip?.departureTime || "")}
              </Text>
